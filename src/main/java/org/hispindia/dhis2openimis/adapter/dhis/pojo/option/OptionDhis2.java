 ...
 */
public class OptionDhis2 {
    
    private String code;
    private String id;
    private String displayName;
    private String shortName;
    private List<OptionAttributeValue>  attributeValues;
    ...
    public String toString() {
            return "OptionDhis2 [code=" + code + ", id=" + id + ", displayName=" + displayName +
                   ", shortName=" + shortName + ", attributeValues=" + attributeValues + "]";
    }
}
